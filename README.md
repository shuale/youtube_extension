...
1. Download the `manifest.json`, `content.js` and `icon.png` files.
   ...
   ![Screenshot of Download button](download_button_screenshot.png)
...
<img alt='Screenshot that shows what the "Developer mode" toggle and "Load unpacked" button look like.' src="https://developer.chrome.com/static/docs/extensions/get-started/tutorial/hello-world/image/extensions-page-e0d64d89a6acf_856.png" width = "50%" />
